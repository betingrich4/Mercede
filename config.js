...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || ">*Status Seen Successfully*",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "> *Ppwered By V8 Engine*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/SXDd8Lp/mrfrankofc.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> *Always Active*",
// add alive msg here 
