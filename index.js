const {
  ...
  let up = `*╭──────────────►*\n> *Mercedes Connected successfully*\n> *Join Us For Updates*\n*https://whatsapp.com/channel/0029Vajvy2kEwEjwAKP4SI0x*\n\n> *Subscribe On YouTube*\n*https://youtube.com/@wemacomic*\n*──────────────►*\n*│✫- Bot Name:* *Mercedes*\n*│✫- Desc:* *Forgotten Project*\n*│✫ - Creator* *Marisel*\n*│✫- Repo:* *https://github.com/betingrich3/Mercedes*\n*Enjoy*\n*PREFIX: ${prefix}*\n*╰──────────────●●►*`;
    conn.sendMessage(conn.user.id, { image: { url: `ttps://i.ibb.co/SXDd8Lp/mrfrankofc.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const ikratos = ('254740007567', '254790375710', '254740007567');
 ...
 if(senderNumber.includes("254740007567")){
  ...
  app.get("/", (req, res) => {
  res.send("Mercedes is running smoothly");
  });
